...
- [Z] We are back on `main`, so we can now do the merge and complete our work!
...
- [Z] Now, we'll want to clean up since we are done with our `task_1` branch.
  - IntelliJ: `Git -> branches... -> task_1 -> Delete`
  - Terminal: `git branch -d task_1`

- [Z] Last step, we'll push our changes to the remote repository to share our work! (As we did in Lab 1.)
